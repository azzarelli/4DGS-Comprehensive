...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], load_coarse=False):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            if "condense" in args.source_path:
                print("Found transforms_train.json file, assuming Condense data set!")
                scene_info = sceneLoadTypeCallbacks["Condense"](args.source_path, args.white_background, args.eval, '.jpg')
