...
import copy
from gaussian_renderer import render, render_no_train, network_gui
...
class GUI:
    ...
    def __init__(self, 
        ...
        self.W, self.H = self.scene.getTestCameras().dataset[0].image.shape[1], self.scene.getTestCameras().dataset[0].image.shape[2]
        ...
        self.training_cams_pc = GaussianCameraModel(self.temp_list, self.W, self.H)
    ...
    def register_dpg(self):
        ...
        with dpg.window(
            ...
            with dpg.collapsing_header(label="Rendering", default_open=True):
                ...
                # Toggle to view training Cameras
                def callback_toggle_train_cam(sender):
    ...
    def viewer_step(self, specified_cam=None):
        ...
        # View training camera or viewer
        if self.train_cam_buffer is None or self.view_training_cameras == False:
            camera = MiniCam(
                self.cam.pose,
                self.W,
                self.H,
    ...
    def train_step(self):
        ...
        # if self.view_training_cameras == True:
        #     self.train_cam_buffer = viewpoint_cams[0]
